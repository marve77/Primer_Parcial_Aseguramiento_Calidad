  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetchWithAuth('/events', {
        method: 'POST',
        // Fetch quita automáticamente el Content-Type y pone los boundaries si usamos FormData
        body: formData,
      });
      ...
      if (res.ok) {
        ...
        setError(errData.message || 'Ocurrió un error al crear el evento.');
      }
    } catch (err) {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="bg-[#003b5c] px-6 py-4 border-b border-gray-100">
            <h1 className="text-xl font-bold text-white font-inter">Crear Nueva Publicación</h1>
          </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-1">
                  <input
                    ...
                    placeholder="Ej. Exposición de Proyectos de Ingeniería"
                  />
                </div>
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-1">
                  <textarea
                    ...
                    className="shadow-sm focus:ring-[#003b5c] focus:border-[#003b5c] block w-full sm:text-sm border-gray-300 rounded-md py-2 px-3 border"
                    placeholder="Describe los detalles principales..."
                  />
                </div>
              </div>
              ...
              <div className="sm:col-span-2">
                ...
                <div className="mt-1">
                  <input
                    ...
                    className="shadow-sm focus:ring-[#003b5c] focus:border-[#003b5c] block w-full sm:text-sm border-gray-300 rounded-md py-2 px-3 border"
                    placeholder="Ej. Auditorio Principal / Laboratorio 3"
                  />
                </div>
              </div>
